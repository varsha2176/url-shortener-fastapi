...
import { Lock, Mail, User, AlertCircle, ArrowRight, UserPlus } from 'lucide-react';
...
function Register({ onRegister }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (onRegister) onRegister(access_token, { username: formData.username });
      navigate('/dashboard');
    } catch (err) {
      setError(
            ...
            <div>
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <User className="h-5 w-5 text-gray-400 group-focus-within:text-gray-900 transition" />
                </div>
                <input
                  id="username"
                  name="username"
